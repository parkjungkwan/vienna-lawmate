...
import site.lawmate.user.domain.vo.Greeting;
import site.lawmate.user.domain.vo.RequestUser;
import site.lawmate.user.domain.vo.ResponseUser;
...
public class UserController {
    ...
    public ResponseEntity<CollectionModel<EntityModel<ResponseUser>>> getUsersWithHateoas() {
        ...
        for (UserEntity user : users) {
            ...
            entityModel.add(linkTo(methodOn(this.getClass()).getUser(user.getUsername())).withSelfRel());
